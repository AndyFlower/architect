 ...
 *
 * @author: sanglp
 * @create: 2020-07-09-8:21
 */
public class ReflectionDemo {
    public static void main(String[] args) throws ClassNotFoundException {
        // 通过反射获取类的Class对象
        Class c1 = Class.forName("com.sanglp.interview.study.annotation.User");
        Class c2 = Class.forName("com.sanglp.interview.study.annotation.User");
        Class c3 = Class.forName("com.sanglp.interview.study.annotation.User");
...
- 已知一个类的全类名，且该类在类路径下，可以通过Class类的静态方法forName()获取，HIA可能抛出ClassNotFoundException
...
public class ClassCreateDemo {
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        //方式2：通过forName获得
        Class c2 = Class.forName("com.sanglp.interview.study.annotation.Student");
...
```
        ...
        C:\Users\Administrator\Desktop\LearningNotes\面试\JUC\Code\target\classes;
 ...
 * 获取运行时类信息
 * @author: sanglp
 * @create: 2020-07-09-12:13
 */
public class GetClassInfo {
    public static void main(String[] args) throws ClassNotFoundException, NoSuchFieldException, NoSuchMethodException {
        Class clazz = Class.forName("com.sanglp.interview.study.annotation.User");
...
//        User user = (User)clazz.newInstance();
        ...
        User user2 = (User) constructor.newInstance("小小", 10, 10);
...
```java
 # java.util.Map<java.lang.String, com.sanglp.interview.study.annotation.User>
class java.lang.String
class com.sanglp.interview.study.annotation.User
 # java.util.List<com.sanglp.interview.study.annotation.User>
class com.sanglp.interview.study.annotation.User
###################
class java.lang.String
class com.sanglp.interview.study.annotation.User
...
public class ORMDemo {
    ...
    public static void main(String[] args) throws Exception{
        // 获取Student 的 Class对象
        Class c1 = Class.forName("com.sanglp.interview.study.annotation.Student2");
